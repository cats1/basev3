export default {
  ...
  newApprove: 'New approval flow',
  level: 'Level',
  defaultInterviewPerson: 'Default receiver',
  onWorkManager: 'The manager on work',
  operator: 'Operator',
  operatorSet: 'Operator setting',
  oneleast: 'Add at least one.',
  mostFive: 'At most 5.',
  tempNameNotNull: "Template's name can't blank",
  roleNameNotNull: "Role's name can't blank",
  roleGroupNameNotNull: "The role group name can't blank",
  loading: 'Loading',
  tempName: 'Template name',
  comAddEmpShowText: 'Please select departments to add staff.',
  passRecord: 'Pass record',
  idcard: 'ID card',
  carId: "Driver's license",
  passport: 'Passport',
  officialCard: 'Military id',
  jobCard: 'Work card',
  others: 'Others',
  filePhoto: 'Photos',
  certType: "Card's type",
  carrytools: 'Tools',
  registinformation: 'Registration information',
  normalText: 'Normal',
  errorText1: 'Error',
  equipCode: 'Equipment number',
  item: '',
  youCanUse: 'you can use',
  youUsed: 'You have used',
  engineRoom: 'engine-room',
  unengineRoom: 'Non-engine room',
  authorArea: 'Authorized area',
  visitArea: 'Visitting area',
  AreaTitle: 'Area',
  addAreaGroup: 'Add area group',
  updateAreaGroup: 'Update area group',
  confirmBtn: 'Comfirm',
  refuseBtn: 'Refuse',
  agentName: 'Agent',
  ...
  pleaseSelectVisittype: 'Please select visitor type',
  ...
  selectCard: 'Please input card number',
  ...
  sempholder1: 'Search employee name',
  as: 'Categorized as',
  defaultText: 'default',
  ...
  endTime: 'End Time',
  pronameIsBlank: 'Project name cannot be empty',
  comnameIsBlank: 'Company name cannot be blank',
  chargeIsBlank: 'The person in charge cannot be empty',
  chargePhoneIsBlank: 'The person in charge cannot be empty',
  dateIsBlank: 'Date cannot be blank',
  moreOneVisit: 'Select up to one visitor',
  selectVisit: 'Please select visitors',
  ...
  h5text: 'Settings for new security protocol',
  h6text: 'Add conference management, increase some functions, such as conference room and view of conference room reservation records;',
  h7text: 'Optimize the employee login process. Employees need to activate their accounts and set passwords for the first time.',
  ...
  h26text: 'Issue an invoice for the purchase of SMS order.',
  ...
  h37text: 'Start using a new logo for “Cool Visit”.',
  h38text: 'Turn on the function of SMS notification.',
  h39text: 'Add the function of visit information search, and support the statistical analysis of “visiting reason”.',
  h40text: 'Add the editing function for the special account (what is a special account).',
  h41text: 'Modify the email notification function, and choose the default configuration, SMTP or Exchange.',
  h42text: 'Support the setting of QR Code as the avatar of the visitor.',
  ...
  approve: {
    ...
    desc1: 'Please set up the approver according to the visittype. The reservation must be approved via the approver before the adoption.',
  ...
  exporttype: {
    ...
    desc10: 'Synchronize DingTalk automatically every day at 00:00',
    ip: 'IP address',
