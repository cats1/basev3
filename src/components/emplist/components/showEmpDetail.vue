	...
	<el-dialog
      ...
      <el-tabs v-model="activeName2" type="card" @tab-click="handleClick">
        <el-tab-pane :label="$t('btn.editEmpBtn')" name="first">
          <el-form :model="form" :rules="rules" ref="empform" label-width="100px" class="demo-ruleForm" :class="{'noedit': empEditClose}">
        ...
        <template v-if="agentShow && editType == 1">
          ...
          <el-form :model="proxy" :rules="rules" ref="porxyform" label-width="100px" class="demo-ruleForm" :class="{'noedit': empEditClose}">
        ...
        <el-tab-pane :label="$t('Proxylist')" name="third" >
          <el-form :model="iproxy" ref="porxyform1" label-width="100px" class="demo-ruleForm" :class="{'noedit': empEditClose}">
...
export default {
  ...
  data () {
      ...
      empEditClose: process.env.empEditClose || false
  	}
  },
  watch: {
    parent (val) {
