...
export default {
  ...
  methods: {
    ...
    showDefaultDom (result) {
        ...
        this.$emit('getmoban',this.defaultmoban)
    },
    saveMoban () {
      ...
      if (checkIsNull(this.defaultmoban.inviteContent) == '') {
        ...
        let nform = {
	        ...
	        companyProfile: replaceQuotation(this.defaultmoban.companyProfile),
	        empEmail: '',
	        empPhone: getCache('empPhone'),
	        inviteContent: replaceQuotation(this.defaultmoban.inviteContent),
	        latitude: this.defaultmoban.latitude,
	        longitude: this.defaultmoban.longitude,
	        templateType: this.mtype,
	        traffic: replaceQuotation(this.defaultmoban.traffic),
	        userid: getCache('userid')
	    }
