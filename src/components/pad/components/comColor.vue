	...
	<div class="marginbom20">
      <notice-show >
        <div slot="header" class="clearfix">
          <one-notice :is-box="false" :is-no-padding="false" :n-icon="imgSrc" :n-title="$t('notice.themecolor.title')" :n-desc="$t('notice.themecolor.desc')" :btn-flag="true" @btn-click="showDown"></one-notice>
          <div class="showbody marginlr20 paddingtb20 " >
            <set-code-time></set-code-time>
          </div>
        </div>        
      </notice-show>
	</div>
