    ...
    <div>
        <div class="visitsetwrap">
            <template v-for="(item,index) in g_config_arr">
                <visit-item-set :vitem="item" :vlength="g_config_arr.length" :vindex="index" :vshow="item.vshow" :vsort="sort" @checkkit="checkEdit" @savekit="saveEdit" @cancelkit="cancelEdit" @delekit="deleteEdit" @upkit="upEdit" @downkit="downEdit"></visit-item-set>
            </template>
