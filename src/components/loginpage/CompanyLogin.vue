<template>
  <el-form class="login-form" autoComplete="on" :model="loginForm" :rules="loginRules" ref="loginForm" label-position="left">
      ...
      <div class="title-container">
         <h3 class="title">{{$t('companyLogin.title')}}</h3>
      ...
      <el-form-item prop="password">
       ...
       <el-button type="primary" style="width:100%;margin-bottom:30px;" :loading="loading" @click.native.prevent="doLogin">{{$t('companyLogin.logIn')}}</el-button>
       </el-row>
      </el-form>
</template>
<script>
