<template>
  <el-form class="login-form" auto-complete="on" :model="loginForm" :rules="loginRules" ref="loginForm" label-position="left">
      ...
      <el-form-item prop="username">
         ...
         <el-input name="account" type="text" v-model="loginForm.account" auto-complete="on" :placeholder="$t('login.username')" />
      </el-form-item>
      <el-form-item prop="password">
          <span class="svg-container">
            <i class="fa fa-lock fa-lg"></i>
          </span>
          <el-input :type="passwordType" auto-complete="off" v-model="loginForm.password"  :placeholder="$t('login.password')" />
         <span class="show-pwd" >
