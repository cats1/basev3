	...
	<div class="marginbom20">
      <notice-show >
        <div slot="header" class="clearfix">
          <one-notice :is-box="false" :is-no-padding="false" :n-icon="imgSrc" :n-title="$t('notice.codetime.title')" :n-desc="$t('notice.codetime.desc')" :btn-flag="true" @btn-click="showDown"></one-notice>
